...
import { WarningFilled, CheckCircleFilled, EditOutlined, DeleteOutlined, CloseCircleFilled, SearchOutlined, ExclamationCircleFilled } from '@ant-design/icons';
import { Tag, Modal, Spin, Button, Select } from 'antd'; // Mover 'Modal' al principio
...
export const Incidentes_Alta = () => {
    ...
    const incidentesAlta = incidentes?.filter(incidente => incidente.gravedad === 'Alta') || [];
    ...
    const showConfirm = (record) => {
        Modal.confirm({
            ...
            content: `Titulo: ${record.titulo}`,
            onOk() {
                deleteIncidente(record.key);
            },
            onCancel() {
                console.log('Cancel');
            },
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (text, record) => {
                const color = record.elemento_inhabilitado === true ? '#D32F2F' : '#B7EB8F' // rojo o verde
                return <CloseCircleFilled style={{ color, fontSize: 20 }} />;
            },
        },
        {
            title: 'Gravedad',
